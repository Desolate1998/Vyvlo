        ...
        <div className='view-body'>
            <div className='account-continer'>
                ...
                <div className='label-container'>
                    ...
                    <Button aria-label='Forgot Password' appearance='transparent'>Forgot Password</Button>
                </div>
                <div className='button-container'>
                    <Button aria-label='Login' appearance='primary' className='login-button' onClick={formik.submitForm}>Login</Button>
                    <Dialog>
                        <DialogTrigger disableButtonEnhancement>
                            <Button aria-label='Need Account?' appearance='secondary'>Need Account?</Button>
                        </DialogTrigger>
                        <Registerform />
                    </Dialog>
                </div>
